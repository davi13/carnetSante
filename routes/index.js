...
var icons = require('../public/javascripts/icons');
            ...
            function(err, episode){
              medecinModel.find(
                ...
                function(err, medecin){
                  ...
                  //   }
                  // );
                  res.render('dashboard', {newEpisode: episode, newMedecin: medecin, user: req.session.user, pictos: icons});
      ...
      function(err, medecin){
        episodeModel.find(
          ...
          function(err, episode) {
            ...
            //   }
            // );
             res.render('dashboard', {newEpisode: episode, newMedecin: medecin, user: req.session.user, error: null, pictos: icons});
            }
        )
